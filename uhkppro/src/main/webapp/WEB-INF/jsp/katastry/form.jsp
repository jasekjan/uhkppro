...
<form:form modelAttribute="katastr" method="${method}">
	<table>
		<tr>
			<td>Kód:</td>
			<td><form:errors path="kod" cssClass="errors" />
				<form:input path="kod" size="30" maxlength="80" /></td>
		</tr>
		<tr>
			<td>Nazev:</td>
			<td><form:errors path="nazev" cssClass="errors" />
				<form:input path="nazev" size="30" maxlength="80" /></td>
		</tr>
		<tr>
			<td><c:choose>
					<c:when test="${katastr['new']}">
